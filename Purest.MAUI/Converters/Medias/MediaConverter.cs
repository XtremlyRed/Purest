...
/// </summary>
public abstract class MediaConverter<From, To> : BindableObject, IValueConverter
    where From : notnull
{
    ...
    /// The null property
    /// </summary>
    public static readonly BindableProperty NullProperty = BindableProperty.Create("Null", typeof(object), typeof(MediaConverter<From, To>), (null));
