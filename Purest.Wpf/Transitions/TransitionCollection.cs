...
public class TransitionCollection : FreezableCollection<TransitionBase>, IList, ICollection<TransitionBase>
{
    /// <summary>
    /// The UI source
    /// </summary>
    ...
    void ICollection<TransitionBase>.Add(TransitionBase animation)
    {
        ...
        {
            Purest.Wpf.Intarnal.Extensions.Register(element!, animation);
        }
        base.Add(animation);
    }
