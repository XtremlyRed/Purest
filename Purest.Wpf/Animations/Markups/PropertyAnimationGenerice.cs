...
public class BrushPropertyAnimation : PropertyAnimationGenerice<Color>, IPropertyAnimation
{
    ...
    protected override AnimationTimeline AnimationBuild(FrameworkElement element, out object propertyOwner)
    {
        ...
        ColorAnimation animation = element.BuildAnimation(property!.Name, From, To, BeginTime, Duration.TimeSpan, base.GetEasingFunction(element));
...
public class Int32PropertyAnimation : PropertyAnimationGenerice<int>
{
    ...
    protected override AnimationTimeline AnimationBuild(FrameworkElement element, out object propertyOwner)
    {
        ...
        Int32Animation animation = element.BuildAnimation(Property!.Name, From, To, BeginTime, Duration.TimeSpan, base.GetEasingFunction(element));
...
public class DoublePropertyAnimation : PropertyAnimationGenerice<double>
{
    ...
    protected override AnimationTimeline AnimationBuild(FrameworkElement element, out object propertyOwner)
    {
        ...
        DoubleAnimation animation = element.BuildAnimation(Property!.Name, From, To, BeginTime, Duration.TimeSpan, base.GetEasingFunction(element));
...
public class ColorPropertyAnimation : PropertyAnimationGenerice<Color>
{
    ...
    protected override AnimationTimeline AnimationBuild(FrameworkElement element, out object propertyOwner)
    {
        ...
        return element.BuildAnimation(Property!.Name, From, To, BeginTime, Duration.TimeSpan, base.GetEasingFunction(element));
    }
}
