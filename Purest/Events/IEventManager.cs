...
public interface IEventManager
{
    ...
    /// <typeparam name="TEvent"></typeparam>
    /// <returns></returns>
    IEventAsync<TEvent> GetEventAsync<TEvent>();
    ...
    /// <param name="channelName"></param>
    /// <returns></returns>
    IEventAsync<TEvent> GetEventAsync<TEvent>(string channelName);
}
...
/// a <see langword="interface"/> of <see cref="IEvent{TEvent}"/>
/// </summary>
public interface IEventAsync<TEvent>
{
    /// <summary>
    /// subscribe message callback
    /// </summary>
    /// <param name="subscribe"></param>
    /// <returns></returns>
    IUnsubscriber Subscribe(Func<TEvent, Task> subscribe);
