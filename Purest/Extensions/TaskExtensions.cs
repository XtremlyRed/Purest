...
public static class TaskExtensions
{
    ...
    /// <returns></returns>
    /// 2024/1/2 16:00
    public static TaskAwaiter<T> GetAwaiter<T>(this (Task<T> task, TimeSpan timeSpan, string timeoutMessage) taskOpt)
    {
    ...
    /// <returns></returns>
    /// 2024/1/2 16:01
    public static TaskAwaiter GetAwaiter(this (Task task, TimeSpan timeSpan, string timeoutMessage) taskOpt)
    {
        ...
        static async Task waitHandle(Task taskResult, TimeSpan delay, string message)
        {
            ...
            Task completedTask = await Task.WhenAny(taskResult, Task.Delay(delay, cancellationTokenSource.Token));
    ...
    /// <param name="tasks">The tasks.</param>
    /// <returns></returns>
    public static TaskAwaiter<(T, T1, T2)> GetAwaiter<T, T1, T2>(this (Task<T>, Task<T1>, Task<T2>) tasks)
    {
        _ = tasks.Item1 ?? throw new ArgumentNullException("task 1");
        _ = tasks.Item2 ?? throw new ArgumentNullException("task 2");
    ...
    /// <param name="tasks">The tasks.</param>
    /// <returns></returns>
    public static TaskAwaiter<(T, T1, T2, T3)> GetAwaiter<T, T1, T2, T3>(this (Task<T>, Task<T1>, Task<T2>, Task<T3>) tasks)
    {
        _ = tasks.Item1 ?? throw new ArgumentNullException("task 1");
        _ = tasks.Item2 ?? throw new ArgumentNullException("task 2");
        _ = tasks.Item3 ?? throw new ArgumentNullException("task 3");
    ...
    /// <param name="tasks">The tasks.</param>
    /// <returns></returns>
    public static TaskAwaiter<(T, T1, T2, T3, T4)> GetAwaiter<T, T1, T2, T3, T4>(this (Task<T>, Task<T1>, Task<T2>, Task<T3>, Task<T4>) tasks)
    {
        _ = tasks.Item1 ?? throw new ArgumentNullException("task 1");
        _ = tasks.Item2 ?? throw new ArgumentNullException("task 2");
        _ = tasks.Item3 ?? throw new ArgumentNullException("task 3");
        ...
        static async Task<(T, T1, T2, T3, T4)> composite((Task<T>, Task<T1>, Task<T2>, Task<T3>, Task<T4>) tasks)
        {
